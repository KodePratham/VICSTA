        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16 mt-8">
            ...
            <div className="text-center mb-10">
              ...
              <p className="font-mono text-xs sm:text-sm text-white/50 mb-4">
                USE THIS OFFICIAL TEMPLATE FOR YOUR ROUND 1 SUBMISSION
              </p>
            ...
            <div className="max-w-4xl mx-auto">
              {/* Download Card */}
              <div className="border-2 border-cyan-400 bg-navy/70 p-6 sm:p-8 relative transition-all duration-300 hover:shadow-[0_0_30px_rgba(34,211,238,0.3)] mb-8">
                {/* Corner decorations */}
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-24 h-24 sm:w-28 sm:h-28 border-2 border-cyan-400 bg-cyan-400/10 flex items-center justify-center shadow-[0_0_20px_rgba(34,211,238,0.2)]">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h3 className="pixel-text text-sm sm:text-base text-cyan-400 mb-2">
                      HACKARENA&apos;26 — OFFICIAL PPT TEMPLATE
                    </h3>
                    <p className="font-mono text-xs sm:text-sm text-white/60 leading-relaxed mb-4">
                      Download the official presentation template to structure your Round 1 idea submission. Follow the slide format below for the best evaluation results.
                    </p>
                    <button
                      onClick={() => {
                        playSound()
                        window.open('https://drive.google.com/drive/folders/12RF2r8444GNor_-o6zgCGWKiX6uPNvlk?usp=sharing', '_blank')
                      }}
                      className="game-button-blue group relative inline-flex items-center gap-3 px-8 py-4 text-xs sm:text-sm font-bold transition-all duration-300 hover:scale-105"
                    >
                      <span className="relative pixel-text text-cyan-400 group-hover:text-navy transition-colors duration-300 flex items-center gap-2">
                        ⬇ DOWNLOAD TEMPLATE
                      </span>
                      <span className="absolute inset-0 bg-cyan-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left -z-10"></span>
                      <span className="absolute inset-0 border-2 border-cyan-400 shadow-[0_0_15px_rgba(34,211,238,0.3)] group-hover:shadow-[0_0_30px_rgba(34,211,238,0.6)] transition-shadow duration-300"></span>
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="border-2 border-blue-400/60 bg-navy/70 p-6 sm:p-8 relative transition-all duration-300 hover:border-blue-400">
                {/* Corner decorations */}
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="pixel-text text-xs sm:text-sm text-blue-400">
                    RECOMMENDED SLIDE STRUCTURE
                  </h3>
                </div>

                <div className="h-0.5 w-full bg-blue-400 opacity-20 mb-6"></div>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { slide: '01', title: 'TITLE SLIDE', desc: 'Team name, hackathon name, chosen problem statement ID & domain', icon: '🏷️' },
                    { slide: '02', title: 'PROBLEM STATEMENT', desc: 'Define the problem clearly, explain why it matters & who it affects', icon: '❓' },
                    { slide: '03', title: 'PROPOSED SOLUTION', desc: 'Your innovative approach, key features & unique selling points', icon: '💡' },
                    { slide: '04', title: 'TECH STACK', desc: 'Technologies, tools, frameworks & architecture you plan to use', icon: '⚙️' },
                    { slide: '05', title: 'IMPACT & FEASIBILITY', desc: 'Expected outcomes, scalability potential & real-world applicability', icon: '🚀' },
                    { slide: '06', title: 'TEAM DETAILS', desc: 'Member names, roles, skills & contact information', icon: '👥' },
                  ].map((item) => (
                    <div
                      key={item.slide}
                      className="group bg-navy/60 border border-blue-400/30 p-4 transition-all duration-300 hover:border-blue-400/80 hover:shadow-[0_0_15px_rgba(96,165,250,0.2)] relative"
                    >
                      {/* Slide number badge */}
                      <div className="flex items-center gap-3 mb-3">
                        <span className="pixel-text text-[10px] bg-blue-400 text-navy px-2 py-1 font-bold">
                          SLIDE {item.slide}
                        </span>
                        <span className="text-xl">{item.icon}</span>
                      </div>
                      <h4 className="pixel-text text-[10px] sm:text-xs text-blue-400 mb-2">
                        {item.title}
                      </h4>
                      <p className="font-mono text-[10px] sm:text-xs text-white/50 leading-relaxed">
                        {item.desc}
                      </p>
                      {/* Corner accents */}
                      <span className="absolute top-0 left-0 w-2 h-2 border-t border-l border-blue-400/50"></span>
                      <span className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-blue-400/50"></span>
                    </div>
                  ))}
                </div>

                {/* Pro Tips */}
                <div className="mt-6 border border-green/30 bg-green/5 p-4 sm:p-5">
                  <div className="flex items-start gap-3">
                    <span className="text-xl flex-shrink-0">💎</span>
                    <div>
                      <h4 className="pixel-text text-[10px] sm:text-xs text-green mb-2">PRO TIPS</h4>
                      <ul className="space-y-2">
                        {[
                          'Keep slides clean & minimal — avoid walls of text',
                          'Use visuals: diagrams, flowcharts & mockups where possible',
                          'Maximum 8-10 slides recommended',
                          'Export as PDF or PPTX before submitting',
                        ].map((tip, i) => (
                          <li key={i} className="font-mono text-[10px] sm:text-xs text-white/50 flex items-start gap-2">
